...
<center><h2><input type="button" name="submit" value="Price : <?php echo $prd->price; ?> ฿" class="w3-button w3-black"onClick="location.href='index.php?menu=dow&pid=<?php echo $prd->id; ?>'"></h2></center>
